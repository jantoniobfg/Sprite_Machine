...
(* CORE_GENERATION_INFO = "buffer_rams,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=buffer_rams,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "buffer_rams.hwdef" *) 
module buffer_rams
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTA_1 ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME PREVIOUS_PORTA_1, MASTER_TYPE OTHER, MEM_ECC NONE, MEM_SIZE 8192, MEM_WIDTH 32, READ_LATENCY 1" *) input [8:0]PREVIOUS_PORTA_1_addr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTA_1 CLK" *) input PREVIOUS_PORTA_1_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTA_1 DIN" *) input [127:0]PREVIOUS_PORTA_1_din;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTA_1 EN" *) input PREVIOUS_PORTA_1_en;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTA_1 WE" *) input [0:0]PREVIOUS_PORTA_1_we;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTB_1 ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME PREVIOUS_PORTB_1, MASTER_TYPE OTHER, MEM_ECC NONE, MEM_SIZE 8192, MEM_WIDTH 32, READ_LATENCY 1" *) input [8:0]PREVIOUS_PORTB_1_addr;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTB_1 CLK" *) input PREVIOUS_PORTB_1_clk;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTB_1 DOUT" *) output [127:0]PREVIOUS_PORTB_1_dout;
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 PREVIOUS_PORTB_1 EN" *) input PREVIOUS_PORTB_1_en;
  ...
  wire [127:0]BRAM_PORTB_1_1_DOUT;
  ...
  assign BRAM_PORTA_1_1_ADDR = PREVIOUS_PORTA_1_addr[8:0];
  assign BRAM_PORTA_1_1_CLK = PREVIOUS_PORTA_1_clk;
  assign BRAM_PORTA_1_1_DIN = PREVIOUS_PORTA_1_din[127:0];
  assign BRAM_PORTA_1_1_EN = PREVIOUS_PORTA_1_en;
  assign BRAM_PORTA_1_1_WE = PREVIOUS_PORTA_1_we[0];
  ...
  assign BRAM_PORTB_1_1_ADDR = PREVIOUS_PORTB_1_addr[8:0];
  assign BRAM_PORTB_1_1_CLK = PREVIOUS_PORTB_1_clk;
  assign BRAM_PORTB_1_1_EN = PREVIOUS_PORTB_1_en;
