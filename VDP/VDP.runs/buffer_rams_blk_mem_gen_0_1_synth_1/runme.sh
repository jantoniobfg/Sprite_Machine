...
HD_PWD='C:/Users/jabilio.000/Documents/git/Sprite_Machine/VDP/VDP.runs/buffer_rams_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buffer_rams_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buffer_rams_blk_mem_gen_0_1.tcl
