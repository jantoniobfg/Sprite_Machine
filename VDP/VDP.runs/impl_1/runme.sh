...
HD_PWD='C:/Users/PC/Documents/Sprite_Machine/VDP/VDP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_manager.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memory_manager.tcl -notrace
