...
HD_PWD='C:/Users/jabilio.000/Documents/git/Sprite_Machine/VDP/VDP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_manager_512.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memory_manager_512.tcl -notrace
