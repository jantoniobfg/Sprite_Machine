...
HD_PWD='C:/Users/jabilio.000/Documents/git/Sprite_Machine/VDP/VDP.runs/frame_buffer_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_buffer_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_buffer_blk_mem_gen_0_0.tcl
